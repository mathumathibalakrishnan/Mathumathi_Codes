...
System.out.println(name +" Signed Up");
	...
	public static void navigationIntoApp() throws Exception {
    	  //driver.manage().timeouts().implicitlyWait(500, TimeUnit.SECONDS);
    	    Thread.sleep(2000); 
       driver.findElement(By.xpath("//*[@class='navigation-link ion-navicon']")).click();
       driver.findElement(By.xpath("//button[@class='cta secondary']")).click();
       driver.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS);
...
driver.findElement(By.xpath("//*[@class='input-box']//input[@type='password']")).sendKeys("test1");
     ...
     // WebElement name = driver.findElement(By.xpath("(//a[@class='navigation-link'])[3]"));
     /*
    ...
    public static void Android() throws MalformedURLException {
